...
class CSkinComboBox_Edit :public CEdit,public ISkinControl
{
	//基本变量
protected:
...
class CSkinComboBox_ListBox : public CListBox,public ISkinControl
{
	//基本变量
protected:
	HWND							m_hOwnerWnd;			//组合框句柄
...
class CSkinComboBox : public CComboBox,public ISkinControl
{
